...
namespace Drupal\ocha_integrations\Plugin\facets\hierarchy;

use Drupal\facets\Hierarchy\HierarchyPluginBase;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * IntegerList hierarchy.
 *
 * @FacetsHierarchy(
 *   id = "ocha_integer_list",
 *   label = @Translation("Interget list hierarchy"),
 *   description = @Translation("Hierarchy structure provided for integer lists.")
 * )
 */
class IntegerList extends HierarchyPluginBase {
